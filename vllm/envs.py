...
if TYPE_CHECKING:
    ...
    VLLM_PLE_NVME_PATH: str | None = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # File-backed FP8 PLE table used by the dedicated CPU offload worker.
    "VLLM_PLE_NVME_PATH": lambda: os.getenv("VLLM_PLE_NVME_PATH") or None,
